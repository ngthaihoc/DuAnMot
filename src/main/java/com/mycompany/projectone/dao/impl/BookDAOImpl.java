...
public class BookDAOImpl implements BookDAO{
    ...
    String findBySupplierSQL = "SELECT b.BookID,Title, b.Author, PublisherYear, Price, cate.CategoryName, sp.SupplierName, s.Quantity   from Books b, Categories cate, Supplier sp, Stock s where b.CategoryID = cate.CategoryID and b.SupplierID = sp.SupplierID and b.BookID = s.BookID and sp.SupplierID = ?";
    String findByCategorySQL = "SELECT b.BookID,Title, b.Author, PublisherYear, Price, cate.CategoryName, sp.SupplierName, s.Quantity   from Books b, Categories cate, Supplier sp, Stock s where b.CategoryID = cate.CategoryID and b.SupplierID = sp.SupplierID and b.BookID = s.BookID and cate.CategoryID = ?";
